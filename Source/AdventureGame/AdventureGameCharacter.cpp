...
{
	// If AdventureGame is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in AdventureGame.Build.cs is not automatically propagated
